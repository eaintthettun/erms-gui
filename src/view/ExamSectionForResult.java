...
public class ExamSectionForResult extends JPanel {
	...
	public ExamSectionForResult() {
		...
		setLayout(new FormLayout(new ColumnSpec[] {
			...
			new RowSpec[] {
				...
				new RowSpec(RowSpec.CENTER, Sizes.bounded(Sizes.DEFAULT, Sizes.constant("90dlu", false), Sizes.constant("200dlu", false)), 0),
				FormFactory.RELATED_GAP_ROWSPEC,
